    ...
    this.routerOutletTabs &&
      this.routerOutletTabs.activateEvents.subscribe((e: any) => {
        ...
        if (!this.last_component) {
          ...
          this.last_component_index =
            this.routerOutletTabs &&
            this.routerOutletTabs.activatedRouteData['index'];
          return;
        }
        ...
        const data_router =
          this.routerOutletTabs && this.routerOutletTabs.activatedRouteData;

        if (
          this.last_component_index != null &&
